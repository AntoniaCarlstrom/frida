...
export const ShopContextProvider = (props) => {
    ...
    useEffect(() => {
      ...
      const contextValue = {products, cartItems, setCartItems, addToCart, removeFromCart, updateCartItemCount, updateQuantity, getTotalPrice, removeAllFromCart, setCartItems};
