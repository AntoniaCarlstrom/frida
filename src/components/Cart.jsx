...
export default function Cart() {
    const { cartItems, products, getTotalPrice, removeAllFromCart } = useContext(ShopContext);
    ...
    async function checkout() {
        ...
        for (const productId in cart) {
          ...
          if (product) {
            ...
            await updateFirebase(productId, product.img, product.name, product.price, newQuantity);
          }
        }
        ...
        <div>
            ...
            <div className="totalContainer">
                <section className="total">
                    ...
                    <button className="emptyCart" onClick={removeAllFromCart}>Empty Cart</button>
